 ...
 * @hidden
 */
var StockDataLookup = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(StockDataLookup, _super);
    function StockDataLookup() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    StockDataLookup.d = function (a, b, c, d, e) {
        if (StockDataLookup.b.containsKey(a)) {
        }
        else {
            var f = new StockPricePoint();
            f.symbol = a;
            f.company = b;
            f.open = c;
            f.close = c;
    ...
    StockDataLookup.get = function (a) {
        if (StockDataLookup.b.containsKey(a)) {
            return StockDataLookup.b.item(a);
        }
        else {
            var b = new StockPricePoint();
            b.symbol = a;
    ...
    StockDataLookup.staticInit = function () {
        var a = dateNow();
    ...
    StockDataLookup.$t = markType(StockDataLookup, 'StockDataLookup');
    StockDataLookup.b = null;
    StockDataLookup.c = new Random(0);
    return StockDataLookup;
}(Base));
export { StockDataLookup };
(function (v) { callStaticConstructors(); })(true);
//# sourceMappingURL=StockDataLookup.js.map
