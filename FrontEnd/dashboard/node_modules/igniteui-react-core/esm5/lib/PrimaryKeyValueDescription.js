 ...
 * @hidden
 */
var PrimaryKeyValueDescription = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(PrimaryKeyValueDescription.prototype, "key", {
        get: function () {
            return this.f;
        },
        set: function (a) {
    ...
    Object.defineProperty(PrimaryKeyValueDescription.prototype, "value", {
        get: function () {
            return this.g;
        },
        set: function (a) {
    ...
    PrimaryKeyValueDescription.__marshalByValue = true;
    PrimaryKeyValueDescription.__marshalByValueAlias = "PrimaryKeyValue";
