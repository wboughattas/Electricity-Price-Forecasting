...
export let CalendarWeekRule_$type = /*@__PURE__*/ markEnum("CalendarWeekRule", "FirstDay,0|FirstFullWeek,1|FirstFourDayWeek,2");
export let Calendar = /*@__PURE__*/ (() => {
    ...
    Calendar.$t = /*@__PURE__*/ markType(Calendar, "Calendar");
    return Calendar;
})();
export let CompareInfo = /*@__PURE__*/ (() => {
    class CompareInfo extends Base {
        compare1(string1, offset1, length1, string2, offset2, length2, options) {
    ...
    CompareInfo.$t = /*@__PURE__*/ markType(CompareInfo, "CompareInfo");
    return CompareInfo;
})();
export let DateTimeFormat = /*@__PURE__*/ (() => {
    class DateTimeFormat extends Base {
        constructor(cultureName, isInvariant) {
            super();
            this._cultureName = null;
            this._isInvariant = false;
            this._dateSeparator = "/";
            this._timeSeparator = ":";
    ...
    DateTimeFormat.$t = /*@__PURE__*/ markType(DateTimeFormat, "DateTimeFormat");
    return DateTimeFormat;
})();
export let NumberFormatInfo = /*@__PURE__*/ (() => {
    class NumberFormatInfo extends Base {
        constructor(cultureName, isInvariant) {
            super();
            this._cultureName = null;
            this._isInvariant = false;
            this._currencySymbol = null;
            this._nativeDigits = null;
            this._negativeSign = "-";
            this._percentSymbol = null;
            this._positiveSign = "+";
    ...
    NumberFormatInfo.$t = /*@__PURE__*/ markType(NumberFormatInfo, "NumberFormatInfo");
    return NumberFormatInfo;
})();
export let Thread = /*@__PURE__*/ (() => {
    ...
    Thread.$t = /*@__PURE__*/ markType(Thread, "Thread");
    return Thread;
})();
...
export let CultureInfo = /*@__PURE__*/ (() => {
    class CultureInfo extends Base {
        constructor(name) {
            super();
            this._name = null;
            this._isInvariant = false;
    ...
    CultureInfo.$t = /*@__PURE__*/ markType(CultureInfo, "CultureInfo");
    return CultureInfo;
})();
