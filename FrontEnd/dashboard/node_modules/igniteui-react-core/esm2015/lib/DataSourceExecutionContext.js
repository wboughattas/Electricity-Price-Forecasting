 ...
 * @hidden
 */
export let DataSourceExecutionContext = /*@__PURE__*/ (() => {
    class DataSourceExecutionContext extends Base {
        constructor() {
            super();
    ...
    DataSourceExecutionContext.$t = /*@__PURE__*/ markType(DataSourceExecutionContext, 'DataSourceExecutionContext', Base.$, [IDataSourceExecutionContext_$type]);
