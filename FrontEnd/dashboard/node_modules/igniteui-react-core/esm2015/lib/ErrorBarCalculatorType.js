 ...
 */
export var ErrorBarCalculatorType = /*@__PURE__*/ (function (ErrorBarCalculatorType) {
    /**
    ...
    return ErrorBarCalculatorType;
})({});
/**
 * @hidden
 */
export let ErrorBarCalculatorType_$type = /*@__PURE__*/ markEnum('ErrorBarCalculatorType', 'Fixed,0|Percentage,1|Data,2|StandardDeviation,3|StandardError,4');
