 ...
 */
export var DataSeriesMarker = /*@__PURE__*/ (function (DataSeriesMarker) {
    /**
    ...
    return DataSeriesMarker;
})({});
/**
 * @hidden
 */
export let DataSeriesMarker_$type = /*@__PURE__*/ markEnum('DataSeriesMarker', 'Automatic,0|None,1|Circle,2|Triangle,3|Pyramid,4|Square,5|Diamond,6|Pentagon,7|Hexagon,8|Tetragram,9|Pentagram,10|Hexagram,11|Hidden,12');
