 ...
 * @hidden
 */
export let UIElementPropertyAccessorFactory = /*@__PURE__*/ (() => {
    class UIElementPropertyAccessorFactory extends Base {
        static get c() {
    ...
    UIElementPropertyAccessorFactory.$t = /*@__PURE__*/ markType(UIElementPropertyAccessorFactory, 'UIElementPropertyAccessorFactory');
 ...
 * @hidden
 */
export let PlatformUIElementPropertyAccessorFactory = /*@__PURE__*/ (() => {
    class PlatformUIElementPropertyAccessorFactory extends UIElementPropertyAccessorFactory {
        constructor() {
            super();
        }
        a(a) {
            switch (a) {
                ...
                case 12:
                case 8:
                case 9: return new CssPixelsPropertyAccessor(this.d(a));
                case 17:
    ...
    PlatformUIElementPropertyAccessorFactory.$t = /*@__PURE__*/ markType(PlatformUIElementPropertyAccessorFactory, 'PlatformUIElementPropertyAccessorFactory', UIElementPropertyAccessorFactory.$);
    return PlatformUIElementPropertyAccessorFactory;
})();
//# sourceMappingURL=UIElementPropertyAccessorFactory_combined.js.map
