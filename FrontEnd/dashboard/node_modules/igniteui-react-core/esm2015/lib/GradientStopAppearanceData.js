 ...
 * @hidden
 */
export let GradientStopAppearanceData = /*@__PURE__*/ (() => {
    class GradientStopAppearanceData extends Base {
        constructor() {
            super(...arguments);
    ...
    GradientStopAppearanceData.$t = /*@__PURE__*/ markType(GradientStopAppearanceData, 'GradientStopAppearanceData', Base.$, [IVisualData_$type]);
