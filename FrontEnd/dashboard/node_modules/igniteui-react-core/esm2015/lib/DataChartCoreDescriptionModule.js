 ...
 * @hidden
 */
export let DataChartCoreDescriptionModule = /*@__PURE__*/ (() => {
    class DataChartCoreDescriptionModule extends Base {
        static register(a) {
    ...
    DataChartCoreDescriptionModule.$t = /*@__PURE__*/ markType(DataChartCoreDescriptionModule, 'DataChartCoreDescriptionModule');
    return DataChartCoreDescriptionModule;
})();
//# sourceMappingURL=DataChartCoreDescriptionModule.js.map
