 ...
 * @hidden
 */
export let CategoryChartDescriptionModule = /*@__PURE__*/ (() => {
    class CategoryChartDescriptionModule extends Base {
        static register(a) {
    ...
    CategoryChartDescriptionModule.$t = /*@__PURE__*/ markType(CategoryChartDescriptionModule, 'CategoryChartDescriptionModule');
