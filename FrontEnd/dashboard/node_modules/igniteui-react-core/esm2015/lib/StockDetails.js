 ...
 * @hidden
 */
export let StockDetails = /*@__PURE__*/ (() => {
    class StockDetails extends StockInfo {
        constructor() {
            super(...arguments);
            this._annualLow = 0;
            this._annualHigh = 0;
            this._marketPrice = 0;
            this._marketShares = 0;
            this._volatility = 0;
        }
        get annualLow() {
    ...
    StockDetails.$t = /*@__PURE__*/ markType(StockDetails, 'StockDetails', StockInfo.$);
    return StockDetails;
})();
