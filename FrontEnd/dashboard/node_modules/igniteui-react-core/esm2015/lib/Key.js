...
export var Key = /*@__PURE__*/ (function (Key) {
    ...
    Key[Key["OemSemicolon"] = 83] = "OemSemicolon";
    Key[Key["OemQuestion"] = 84] = "OemQuestion";
    Key[Key["OemPipe"] = 85] = "OemPipe";
    Key[Key["OemTilde"] = 86] = "OemTilde";
    Key[Key["OemPlus"] = 87] = "OemPlus";
    Key[Key["OemMinus"] = 88] = "OemMinus";
 ...
 * @hidden
 */
export let Key_$type = /*@__PURE__*/ markEnum('Key', 'None,0|Back,1|Tab,2|Enter,3|Shift,4|Ctrl,5|Alt,6|CapsLock,7|Escape,8|Space,9|PageUp,10|PageDown,11|End,12|Home,13|Left,14|Up,15|Right,16|Down,17|Insert,18|Delete:del,19|D0,20|D1,21|D2,22|D3,23|D4,24|D5,25|D6,26|D7,27|D8,28|D9,29|A,30|B,31|C,32|D,33|E,34|F,35|G,36|H,37|I,38|J,39|K,40|L,41|M,42|N,43|O,44|P,45|Q,46|R,47|S,48|T,49|U,50|V,51|W,52|X,53|Y,54|Z,55|F1,56|F2,57|F3,58|F4,59|F5,60|F6,61|F7,62|F8,63|F9,64|F10,65|F11,66|F12,67|NumPad0,68|NumPad1,69|NumPad2,70|NumPad3,71|NumPad4,72|NumPad5,73|NumPad6,74|NumPad7,75|NumPad8,76|NumPad9,77|Multiply,78|Add,79|Subtract,80|Decimal,81|Divide,82|OemSemicolon,83|OemQuestion,84|OemPipe,85|OemTilde,86|OemPlus,87|OemMinus,88|Unknown,255');
