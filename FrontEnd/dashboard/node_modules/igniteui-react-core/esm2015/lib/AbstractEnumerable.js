 ...
 * @hidden
 */
export let AbstractEnumerable = /*@__PURE__*/ (() => {
    class AbstractEnumerable extends Base {
        constructor(a) {
            super();
            this.a = null;
            this.a = a;
    ...
    AbstractEnumerable.$t = /*@__PURE__*/ markType(AbstractEnumerable, 'AbstractEnumerable', Base.$, [IEnumerable_$type]);
