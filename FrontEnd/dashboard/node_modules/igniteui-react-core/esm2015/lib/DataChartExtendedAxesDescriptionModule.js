 ...
 * @hidden
 */
export let DataChartExtendedAxesDescriptionModule = /*@__PURE__*/ (() => {
    class DataChartExtendedAxesDescriptionModule extends Base {
        static register(a) {
    ...
    DataChartExtendedAxesDescriptionModule.$t = /*@__PURE__*/ markType(DataChartExtendedAxesDescriptionModule, 'DataChartExtendedAxesDescriptionModule');
