 ...
 * @hidden
 */
export let GetTileImageUriArgs = /*@__PURE__*/ (() => {
    class GetTileImageUriArgs extends EventArgs {
        constructor(a, b, c) {
            super();
            this._tileLevel = 0;
    ...
    GetTileImageUriArgs.$t = /*@__PURE__*/ markType(GetTileImageUriArgs, 'GetTileImageUriArgs', EventArgs.$);
