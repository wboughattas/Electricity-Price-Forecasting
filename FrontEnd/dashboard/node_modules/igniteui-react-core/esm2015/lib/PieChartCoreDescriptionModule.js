 ...
 * @hidden
 */
export let PieChartCoreDescriptionModule = /*@__PURE__*/ (() => {
    class PieChartCoreDescriptionModule extends Base {
        static register(a) {
    ...
    PieChartCoreDescriptionModule.$t = /*@__PURE__*/ markType(PieChartCoreDescriptionModule, 'PieChartCoreDescriptionModule');
