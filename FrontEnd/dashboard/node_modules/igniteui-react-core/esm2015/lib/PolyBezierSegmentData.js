 ...
 * @hidden
 */
export let PolyBezierSegmentData = /*@__PURE__*/ (() => {
                ...
                case 1:
                    {
                        let c = _rest[0];
                        this.points = new List$1(PointData.$, 0);
                        for (let d = 0; d < c.b.count; d++) {
                            this.points.add(PointData.b(c.b._inner[d]));
                        }
                    }
                    break;
            }
    ...
    PolyBezierSegmentData.$t = /*@__PURE__*/ markType(PolyBezierSegmentData, 'PolyBezierSegmentData', SegmentData.$);
