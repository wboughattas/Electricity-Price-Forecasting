 ...
 * @hidden
 */
export let LineVisualData = /*@__PURE__*/ (() => {
    class LineVisualData extends PrimitiveVisualData {
        constructor(a, ..._rest) {
            a = (a == void 0) ? 0 : a;
            switch (a) {
                case 0:
    ...
    LineVisualData.$t = /*@__PURE__*/ markType(LineVisualData, 'LineVisualData', PrimitiveVisualData.$);
