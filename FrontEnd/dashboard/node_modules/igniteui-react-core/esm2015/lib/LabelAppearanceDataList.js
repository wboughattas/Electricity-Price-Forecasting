 ...
 * @hidden
 */
export let LabelAppearanceDataList = /*@__PURE__*/ (() => {
    class LabelAppearanceDataList extends List$1 {
        constructor() {
    ...
    LabelAppearanceDataList.$t = /*@__PURE__*/ markType(LabelAppearanceDataList, 'LabelAppearanceDataList', /*@__PURE__*/ List$1.$.specialize(LabelAppearanceData.$), [IVisualData_$type]);
