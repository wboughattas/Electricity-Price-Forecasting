 ...
 * @hidden
 */
export let DOMExecutionContext = /*@__PURE__*/ (() => {
    class DOMExecutionContext extends Base {
        constructor(a) {
            super();
            this.c = 0;
            this.b = null;
    ...
    DOMExecutionContext.$t = /*@__PURE__*/ markType(DOMExecutionContext, 'DOMExecutionContext', Base.$, [IExecutionContext_$type]);
