 ...
 * @hidden
 */
export let PolygonVisualData = /*@__PURE__*/ (() => {
    class PolygonVisualData extends PrimitiveVisualData {
        constructor(a, ..._rest) {
            a = (a == void 0) ? 0 : a;
            switch (a) {
                case 0:
                ...
                case 1:
                    {
                        ...
                        for (let e = 0; e < d.ak.count; e++) {
                            this.points.add(PointData.b(d.ak._inner[e]));
                        }
    ...
    PolygonVisualData.$t = /*@__PURE__*/ markType(PolygonVisualData, 'PolygonVisualData', PrimitiveVisualData.$);
