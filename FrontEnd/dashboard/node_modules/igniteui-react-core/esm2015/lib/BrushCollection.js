 ...
 * @hidden
 */
export let BrushCollection = /*@__PURE__*/ (() => {
    class BrushCollection extends ObservableCollection$1 {
        constructor() {
            super(Brush.$, 0);
            this.ae = 0;
        }
    ...
    BrushCollection.$t = /*@__PURE__*/ markType(BrushCollection, 'BrushCollection', /*@__PURE__*/ ObservableCollection$1.$.specialize(Brush.$));
    BrushCollection.ag = /*@__PURE__*/ new Random(0);
